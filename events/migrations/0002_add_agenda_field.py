...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.agenda'
        db.add_column(u'events_event', 'agenda',
                      self.gf('django.db.models.fields.CharField')(default='be', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.agenda'
        db.delete_column(u'events_event', 'agenda')
    ...
    models = {
        ...
        u'events.event': {
            ...
            'agenda': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
