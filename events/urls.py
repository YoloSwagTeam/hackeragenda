...
urlpatterns = patterns('events.views',
    ...
    url(r'^month/(?P<year>\d+)/(?P<month>\d+)/$', EventMonthArchiveView.as_view(), name='events_render'),
    url(r'^week/(?P<year>\d+)/(?P<week>\d+)/$', EventWeekArchiveView.as_view(), name='events_render'),
