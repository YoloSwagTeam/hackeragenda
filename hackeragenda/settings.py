...
PREDEFINED_FILTERS["default"] = {
    ...
    "exclude_source": [
        ...
        "belgian_java_user_group",
        "belgian_puppet_user_group",
        "belgian_ruby_user_group",
        "belgian_software_craftsmanship_guild",
        "belgium_tableau_software_data_analytics_user_group_meetup",
        "bigdata_be",
        "budalab",
        ...
        "brussels_wordpress",
        "ddd_belgium",
        "devspace_elixir_study_group",
        "docker_belgium",
        "ember_js_brussels",
        "fablab_bornem",
        "hasselt_php_meetup",
        "icon_brussels_research_and_education_group",
        "imal",
        "internet_of_things_ghent",
        "iot_be",
        "laravel_brussels",
        "le_wagon_brussels_coding_station",
        ...
        "ruby_burgers",
        "streamprocessing_be",
        "symfony_user_group_belgium",
        "timelab",
        "wajug_be",
        "webrtc",
        "web_and_mobile_development_wvl",
    ],
    "tag": [],
    "exclude_tag": ["meeting"],
}
